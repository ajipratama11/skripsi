<div class="content-wrapper">
    <section class="content-header">
        <h1 class="text-center">Coba Konversi Bobot</h1>
    </section>
                ...
                <form action="<?= base_url('Admin/coba_konversi_nilai') ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select name="biologi" class="form-control" required="">
                            ...
                            <option value="4" <?php if ($datanilai->biologi >= 69 && $datanilai->biologi <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="3" <?php if ($datanilai->biologi >= 0 && $datanilai->biologi <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="fisika" class="form-control" required="">
                            ...
                            <option value="4" <?php if ($datanilai->fisika >= 69 && $datanilai->fisika <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="3" <?php if ($datanilai->fisika >= 0 && $datanilai->fisika <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select name="bhs_inggris" class="form-control" required="">
                            ...
                            <option value="4" <?php if ($datanilai->bhs_inggris >= 69 && $datanilai->bhs_inggris <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="3" <?php if ($datanilai->bhs_inggris >= 0 && $datanilai->bhs_inggris <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="bhs_indonesia" class="form-control" required="">
                            ...
                            <option value="4" <?php if ($datanilai->bhs_indonesia >= 69 && $datanilai->bhs_indonesia <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="3" <?php if ($datanilai->bhs_indonesia >= 0 && $datanilai->bhs_indonesia <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="realistis" class="form-control" required="">
                            ...
                            <option value="3" <?php if ($datanilai->realistis >= 69 && $datanilai->realistis <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="2" <?php if ($datanilai->realistis >= 0 && $datanilai->realistis <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select name="artistik" class="form-control" required="">
                            ...
                            <option value="3" <?php if ($datanilai->artistik >= 69 && $datanilai->artistik <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="2" <?php if ($datanilai->artistik >= 0 && $datanilai->artistik <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="sosial" class="form-control" required="">
                            ...
                            <option value="3" <?php if ($datanilai->sosial >= 69 && $datanilai->sosial <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="2" <?php if ($datanilai->sosial >= 0 && $datanilai->sosial <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="enterprise" class="form-control" required="">
                            ...
                            <option value="3" <?php if ($datanilai->enterprise >= 69 && $datanilai->enterprise <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="2" <?php if ($datanilai->enterprise >= 0 && $datanilai->enterprise <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="konvensional" class="form-control" required="">
                            ...
                            <option value="3" <?php if ($datanilai->konvensional >= 69 && $datanilai->konvensional <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="2" <?php if ($datanilai->konvensional >= 0 && $datanilai->konvensional <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="linguistik" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->linguistik >= 69 && $datanilai->linguistik <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->linguistik >= 0 && $datanilai->linguistik <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="matematikal" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->matematikal >= 69 && $datanilai->matematikal <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->matematikal >= 0 && $datanilai->matematikal <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="musikal" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->musikal >= 69 && $datanilai->musikal <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->musikal >= 0 && $datanilai->musikal <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="kinestik" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->kinestik >= 69 && $datanilai->kinestik <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->kinestik >= 0 && $datanilai->kinestik <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="spartial" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->spartial >= 69 && $datanilai->spartial <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->spartial >= 0 && $datanilai->spartial <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="intrapersonal" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->intrapersonal >= 69 && $datanilai->intrapersonal <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->intrapersonal >= 0 && $datanilai->intrapersonal <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="interpersonal" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->interpersonal >= 69 && $datanilai->interpersonal <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->interpersonal >= 0 && $datanilai->interpersonal <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="natrularistik" class="form-control" required="">
                            <option value="">Nilai...</option>
                            <option value="3" <?php if ($datanilai->natrularistik >= 80 && $datanilai->natrularistik <= 100) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Tinggi</option>
                            <option value="2" <?php if ($datanilai->natrularistik >= 69 && $datanilai->natrularistik <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->natrularistik >= 0 && $datanilai->natrularistik <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <select name="eksistensial" class="form-control" required="">
                            ...
                            <option value="2" <?php if ($datanilai->eksistensial >= 69 && $datanilai->eksistensial <= 79) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Normal</option>
                            <option value="1" <?php if ($datanilai->eksistensial >= 0 && $datanilai->eksistensial <= 68) {
                                                        echo "selected=\"selected\"";
                                                    } ?>>Rendah</option>
                        </select>
                    </div>
