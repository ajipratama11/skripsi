<div class="content-wrapper">
    <section class="content-header">
        <h1 class="text-center">Konvert Nilai</h1>
    </section>
    ...
    <section class="content">
        <div class="box box-warning">
            ...
            <div class="box-body">
                <form action="<?= base_url('KlasifikasiNB/hasil_nb') ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-success">Hasil Klasifikasi</button>
                    </div>
                </form>
            </div>
        </div>
