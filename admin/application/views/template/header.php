...
<head>
  ...
  <title><?= $title;?> | Aplikasi Penentuan Jurusan Kuliah </title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url();?>" class="logo">
      ...
      <span class="logo-mini"><b>APJK</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Penentuan Jurusan</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <?php
      ...
      if($this->session->status == 'admin'){ ?>
         <li class="treeview">
        <a href="#">
        <i class="fa fa-book text-aqua"></i> <span>Penjurusan Kuliah</span>
        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
          <ul class="treeview-menu">
            <li class="">
              <a href="<?= base_url('kriteria');?>"><i class="fa fa-circle-o"></i><span>Kriteria</span></a>
        ...
        <li class="treeview">
        <a href="#">
        <i class="fa fa-table text-aqua"></i> <span>Nilai Ujian</span>
        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
          <ul class="treeview-menu">
            <?php foreach($perkelas as $pk){ ?>
